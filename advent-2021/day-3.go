...
// iterates over matrix for the column defined in column and rows defined in selection
// for instance if we have a matrix with 10 rows, having selection as [0,1,7] will only
// consider rows 0, 1 and 7 for the position defined in column.
...
// same as mostCommonBits, but searching for least common bits and when in draw considering
// columns with 0
